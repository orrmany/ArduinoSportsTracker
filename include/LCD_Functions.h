...
const int scePin = 12;   // SCE - Chip select, pin 3 on LCD.
const int rstPin = 9;   // RST - Reset, pin 4 on LCD.
const int dcPin = 11;    // DC - Data/Command, pin 5 on LCD.
const int sdinPin = PIN_SPI_MOSI;  // DN(MOSI) - Serial data, pin 6 on LCD.
const int sclkPin = PIN_SPI_SCK;  // SCLK - Serial clock, pin 7 on LCD.
const int blPin = PIN_A0;    // LED - Backlight LED, pin 8 on LCD.
